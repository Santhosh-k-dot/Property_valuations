...
import {
    ...
    Grid, Card, CardContent, CardMedia, Fade, Box, IconButton
} from '@mui/material';
...
const AdvPropertyCardBuy = () => {
    ...
    const PropertyCard = ({ property }) => {
        const [hover, setHover] = useState(false); // Track hover state for animations
        ...
        return (
            ...
            >
                <Fade in={true} timeout={1500}>
                    <div> {/* Wrapping Card in a div to ensure proper structure */}
                        <Card
                            sx={{
                        ...
                        >
                            ...
                            <CardContent sx={{ padding: '20px' }}>
                                ...
                                <Typography variant="body2" sx={{ marginBottom: '6px', color: '#616161' }}>
                                    Location: <strong>{property.location}</strong>
                                </Typography>
                                <Typography variant="body2" sx={{ marginBottom: '6px', color: '#616161' }}>
                                    Pincode: <strong>{property.pincode}</strong>
                                </Typography>
                                <Typography
                                    variant="body2"
                                    sx={{
                                ...
                                <Typography variant="body2" sx={{ marginBottom: '6px', color: '#616161' }}>
                                    Type: <strong>{property.propertyType}</strong>
                                </Typography>
                                <Typography variant="body2" sx={{ color: '#616161', marginBottom: '16px' }}>
                                    Category: <strong>{property.category}</strong>
                                </Typography>
                                <Button
                                    variant="contained"
                                    sx={{
                                        ...
                                        '&:hover': {
                                            ...
                                            boxShadow: '0px 6px 16px rgba(21, 90, 159, 0.7)',
                                        },
                                    }}
    ...
    return (
        <Box sx={{ p: 2, display: 'flex', justifyContent: 'center' }}>
            <Card sx={mainCardStyles}>
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                        Explore a wide range of properties available for sale with expert assistance to
            ...
            <Dialog open={openDialog} onClose={handleDialogClose} fullScreen fullWidth maxWidth="lg">
                <DialogTitle sx={{ backgroundColor: '#f0f0f0', p: 0 }}>
                    {/* Auto-scrolling Promotional Banner */}
                    <Box
                        sx={{
          ...
          0 0 2px #007acc`,
                        ...
                        >
                            🔥 Limited Time Offer: Get a 10% Discount on Property Deals! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            🚀 Hurry! New Launch Offers Available. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            🏡 Book your dream property today with zero processing fees! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            🎉 Special deals only for early investors! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </Typography>
                    </Box>
                ...
                {/* CSS for Slow Auto-Scrolling Animation */}
                <style>
                    {`
